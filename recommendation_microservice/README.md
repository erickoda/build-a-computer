...
```bash
protoc -I pkg/protos --experimental_allow_proto3_optional --go_out=. --go_opt=module=github.com/erickoda/build-a-computer/recommendation_microservice \
--go-grpc_out=. --go-grpc_opt=module=github.com/erickoda/build-a-computer/recommendation_microservice pkg/protos/*.proto
```
